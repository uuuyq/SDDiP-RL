...
CONFIG_STORAGE = {}
CONFIG_JSON_PATH = r"D:\tools\workspace_pycharm\SDDiP-RL\bundle_norm_RL\configs\configs.json"
CONFIG_PKL_PATH = r"D:\tools\workspace_pycharm\SDDiP-RL\bundle_norm_RL\configs\configs.pkl"
...
def collect_and_save_config(
    ...
    """收集并保存完整的LevelBundleConfig对象"""
    key = (i, t, n)
    config = LevelBundleConfig(
        T=T,
        N_VARS=N_VARS,
        X_TRIAL=X_TRIAL,
        Y_TRIAL=Y_TRIAL,
