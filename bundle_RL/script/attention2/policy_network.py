...
===========================================
    ...
    action_mean = LambdaHead(h, H)                 shape (B, K)
    log_std     = self.log_std                     shape (K,) (父类创建)
...
===========================================
    ...
    Policy 输出的 action 是 raw_lambda（未做 mask/softmax）。
...
class AttentionActorCriticPolicy(ActorCriticPolicy):
    ...
    def _compute_action_mean(
        ...
        """
        action_mean = lambda_mean，shape (B, K)
        """
